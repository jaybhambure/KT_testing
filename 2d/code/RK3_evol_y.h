#include "evol_functions_y.h"

using namespace std;

	void RK3_y(double *E, double *M_x, double *M_y)
	{
...
res_M_y = F_M_yy(E_1[L_coord], E_1[cell_p], E_1[cell_pp], E_1[cell_m], E_1[cell_mm], M_x_1[L_coord], M_x_1[cell_p], M_x_1[cell_pp], M_x_1[cell_m], M_x_1[cell_mm], M_y_1[L_coord], M_y_1[cell_p], M_y_1[cell_pp], M_y_1[cell_m], M_y_1[cell_mm]);
	...
	E_2[L_coord] = 3.0/4.0*E[L_coord] + 1.0/4.0*( E_1[L_coord] + dt/dy * res_E );
	M_x_2[L_coord] = 3.0/4.0*M_x[L_coord] + 1.0/4.0*( M_x_1[L_coord] + dt/dy * res_M_x );
	M_y_2[L_coord] = 3.0/4.0*M_y[L_coord] + 1.0/4.0*( M_y_1[L_coord] + dt/dy * res_M_y );
	...
	if (regulator==1)
	{
	regulate_central_cell_values(E_2, M_x_2, M_y_2, 0, 1);
	regulate_half_cell_values(E_2, M_x_2, M_y_2, 0, 1);
	}
	...
	res_E = F_E_y(E_2[L_coord], E_2[cell_p], E_2[cell_pp], E_2[cell_m], E_2[cell_mm], M_x_2[L_coord], M_x_2[cell_p], M_x_2[cell_pp], M_x_2[cell_m], M_x_2[cell_mm], M_y_2[L_coord], M_y_2[cell_p], M_y_2[cell_pp], M_y_2[cell_m], M_y_2[cell_mm]);
	res_M_x = F_M_yx(E_2[L_coord], E_2[cell_p], E_2[cell_pp], E_2[cell_m], E_2[cell_mm], M_x_2[L_coord], M_x_2[cell_p], M_x_2[cell_pp], M_x_2[cell_m], M_x_2[cell_mm], M_y_2[L_coord], M_y_2[cell_p], M_y_2[cell_pp], M_y_2[cell_m], M_y_2[cell_mm]);
	res_M_y = F_M_yy(E_2[L_coord], E_2[cell_p], E_2[cell_pp], E_2[cell_m], E_2[cell_mm], M_x_2[L_coord], M_x_2[cell_p], M_x_2[cell_pp], M_x_2[cell_m], M_x_2[cell_mm], M_y_2[L_coord], M_y_2[cell_p], M_y_2[cell_pp], M_y_2[cell_m], M_y_2[cell_mm]);

	E_3[L_coord] = 1.0/3.0*E[L_coord] + 2.0/3.0*(E_2[L_coord] + dt/dy * res_E );
	M_x_3[L_coord] = 1.0/3.0*M_x[L_coord] + 2.0/3.0*(M_x_2[L_coord] + dt/dy * res_M_x );
	M_y_3[L_coord] = 1.0/3.0*M_y[L_coord] + 2.0/3.0*(M_y_2[L_coord] + dt/dy * res_M_y );
	...
	double p = pressure(E_3[L_coord], M_x_3[L_coord], M_y_3[L_coord]);
		...
		{
		flag = 1;	
		cout<<"Step 3, presure negative"<<" pressure: "<<p<<" E_3: "<<E_3[L_coord]<<" "<<L_coord<<" res_E: "<<dt/dy * res_E<<" res_M: "<<dt/dy*res_M_x<<" Mx: "<<M_x_3[L_coord]<<endl;
		}
	...
	if (regulator==1)
	{
	regulate_central_cell_values(E_3, M_x_3, M_y_3, 0, 1);
	regulate_half_cell_values(E_3, M_x_3, M_y_3, 0, 1);
	}
